...
from src.domain import (Model, Point2D, Restriction, Mode, EpistemicStatus,
                        EvidenceGrade, AlertCommand)
...
class SemanticEnvelope(Model):
    ...
    def grade_and_source(self) -> SemanticEnvelope:
        ...
        if kind in ("TICKET_BOUND", "TICKET_RELEASED", "OPERATOR_ASSERTION") and self.source != "OPERATOR":
...
Event = Annotated[
    ContactBegin | ContactEnd | ZoneEntry | ZoneExit | GloveChange | ToolSwap | SurfaceSwap | WashCycle | OperatorAssertion | SurfaceWipe | TicketReceived | TicketRestrictionResolved | TicketBlocked | TicketBound | TicketPrepStarted | TicketItemComplete | TicketHeld | TicketReleased | TicketVoided | TicketReworkOpened | TicketItemSubstituted | StationModeChanged | CarrierObservabilityChanged | TrackIdentitySuspect | ConfigLoaded | HealthDegraded | AlertRaised | AlertUpdated | AlertAcknowledged | AlertResolved | AlertEscalated | AlertExpired | AlertSuppressed,
    Field(discriminator="type"),
]
EVENT_ADAPTER: TypeAdapter[Event] = TypeAdapter(Event)

DraftEvent = Annotated[
    DraftContactBegin | DraftContactEnd | DraftZoneEntry | DraftZoneExit | DraftGloveChange | DraftToolSwap | DraftSurfaceSwap | DraftWashCycle | DraftOperatorAssertion | DraftSurfaceWipe | DraftTicketReceived | DraftTicketRestrictionResolved | DraftTicketBlocked | DraftTicketBound | DraftTicketPrepStarted | DraftTicketItemComplete | DraftTicketHeld | DraftTicketReleased | DraftTicketVoided | DraftTicketReworkOpened | DraftTicketItemSubstituted | DraftStationModeChanged | DraftCarrierObservabilityChanged | DraftTrackIdentitySuspect | DraftConfigLoaded | DraftHealthDegraded | DraftAlertRaised | DraftAlertUpdated | DraftAlertAcknowledged | DraftAlertResolved | DraftAlertEscalated | DraftAlertExpired | DraftAlertSuppressed,
    Field(discriminator="type"),
]
DRAFTEVENT_ADAPTER: TypeAdapter[DraftEvent] = TypeAdapter(DraftEvent)

GradedEvent = Annotated[
    GradedContactBegin | GradedContactEnd | GradedZoneEntry | GradedZoneExit | GradedGloveChange | GradedToolSwap | GradedSurfaceSwap | GradedWashCycle | GradedOperatorAssertion | GradedSurfaceWipe | GradedTicketReceived | GradedTicketRestrictionResolved | GradedTicketBlocked | GradedTicketBound | GradedTicketPrepStarted | GradedTicketItemComplete | GradedTicketHeld | GradedTicketReleased | GradedTicketVoided | GradedTicketReworkOpened | GradedTicketItemSubstituted | GradedStationModeChanged | GradedCarrierObservabilityChanged | GradedTrackIdentitySuspect | GradedConfigLoaded | GradedHealthDegraded | GradedAlertRaised | GradedAlertUpdated | GradedAlertAcknowledged | GradedAlertResolved | GradedAlertEscalated | GradedAlertExpired | GradedAlertSuppressed,
    Field(discriminator="type"),
]
GRADEDEVENT_ADAPTER: TypeAdapter[GradedEvent] = TypeAdapter(GradedEvent)

EVENT_TYPES = ('CONTACT_BEGIN', 'CONTACT_END', 'ZONE_ENTRY', 'ZONE_EXIT', 'GLOVE_CHANGE', 'TOOL_SWAP', 'SURFACE_SWAP', 'WASH_CYCLE', 'OPERATOR_ASSERTION', 'SURFACE_WIPE', 'TICKET_RECEIVED', 'TICKET_RESTRICTION_RESOLVED', 'TICKET_BLOCKED', 'TICKET_BOUND', 'TICKET_PREP_STARTED', 'TICKET_ITEM_COMPLETE', 'TICKET_HELD', 'TICKET_RELEASED', 'TICKET_VOIDED', 'TICKET_REWORK_OPENED', 'TICKET_ITEM_SUBSTITUTED', 'STATION_MODE_CHANGED', 'CARRIER_OBSERVABILITY_CHANGED', 'TRACK_IDENTITY_SUSPECT', 'CONFIG_LOADED', 'HEALTH_DEGRADED', 'ALERT_RAISED', 'ALERT_UPDATED', 'ALERT_ACKNOWLEDGED', 'ALERT_RESOLVED', 'ALERT_ESCALATED', 'ALERT_EXPIRED', 'ALERT_SUPPRESSED')
